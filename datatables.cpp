...
std::vector<ParticleData> initializeParticleData()
{
    ...
    data[Particle::Default].color = sf::Color(255, 0, 0);
    data[Particle::Default].lifetime = sf::seconds(0.9f);
...
std::vector<EntityData> initializeEntityData()
{
    ...
    data[Entity::Player].healthpoints = 20;
    data[Entity::Player].damages = 8;
    data[Entity::Player].speed = 200.f;
    data[Entity::Player].fireInterval = sf::seconds(0.5f);


    data[Entity::Rabbit].healthpoints = 1;
    data[Entity::Rabbit].damages = 5;
    data[Entity::Rabbit].speed = 75.f;
    data[Entity::Rabbit].fireInterval = sf::Time::Zero;

    data[Entity::Crawler].healthpoints = 15;
    data[Entity::Crawler].damages = 5;
    data[Entity::Crawler].speed = 50.f;
    data[Entity::Crawler].fireInterval = sf::Time::Zero;

    data[Entity::Tentacle].healthpoints = 5;
    data[Entity::Tentacle].damages = 7;
    data[Entity::Tentacle].speed = 90.f;
    data[Entity::Tentacle].fireInterval = sf::Time::Zero;

    data[Entity::Boss1].healthpoints = 160;
    data[Entity::Boss1].damages = 20;
    data[Entity::Boss1].speed = 50.f;
    data[Entity::Boss1].fireInterval = sf::Time::Zero;

    data[Entity::Boss2].healthpoints = 200;
    data[Entity::Boss2].damages = 20;
    data[Entity::Boss2].speed = 90.f;
    data[Entity::Boss2].fireInterval = sf::Time::Zero;

    data[Entity::Boss3].healthpoints = 500;
    data[Entity::Boss3].damages = 20;
    data[Entity::Boss3].speed = 50.f;
    data[Entity::Boss3].fireInterval = sf::Time::Zero;
...
{
    std::vector<std::vector<Phase>> data(Entity::TypeCount);
